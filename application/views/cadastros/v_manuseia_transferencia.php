...
<div class="page-content" id="manusear_despesas">
        ...
        <div class="widget-container fluid-height">
          <div class="box-typical-body">
            <form action="<?= base_url("conta/gravar")?>" method="post">
              		...
              		<div class="col-lg-10" id="manusear_despesa">
              				<fieldset class="form-group">
              					...
              					<input class="form-control proximo_campo" id="nome" name="nome" type="text" value= "" placeholder="Descrição da Transferencia" size="40" required>
              				</fieldset>
              		</div>
                  <div class="col-lg-2" id="div_valor">
                      <fieldset class="form-group">
                        <label class="form-label" for="valor">Valor*</label>
                        <input class="form-control proximo_campo" id="valor" name="valor" type="number" value= "0" step="0.01" size="30" required>
                      </fieldset>
                  </div>
