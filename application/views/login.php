      ...
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <form>
            ...
            <a class="btn btn-primary btn-block" href="<?= base_url('include');?>/index.html">Login</a>
          </form>
          <div class="text-center">
            <a class="d-block small mt-3" href="<?= base_url('include');?>/register.html">Register an Account</a>
            <a class="d-block small" href="<?= base_url('include');?>/forgot-password.html">Forgot Password?</a>
          </div>
        </div>
      </div>
    </div>
